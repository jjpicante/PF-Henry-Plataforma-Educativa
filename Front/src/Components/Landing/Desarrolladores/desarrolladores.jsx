      ...
      <div className={styles.allIntegrantes}>
        ...
        <section className={styles.integrante}>
          ...
          <div className={styles.textos}>
            ...
            <p>
            Desde que tengo uso de razón, he buscado oportunidades para ampliar mi conocimiento en distintas áreas. 
            He estudiado música, soy preceptora en nivel secundario y también me desempeño como peluquera canina. 
            Actualmente, estoy cursando la carrera de Ingeniería Industrial.
            </p>

            <p>
            Motivada por mi interés en adquirir nuevos conocimientos y por el afán de seguir incursionando en nuevas disciplinas, 
            me interesé por la programación. Creo que esta disciplina ofrece muchas posibilidades y puedo utilizarla como complemento para mi formación universitaria.
            </p>
          </div>
        </section>
        <section className={styles.integrante}>
