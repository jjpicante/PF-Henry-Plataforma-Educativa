      ...
      <div className={styles.allIntegrantes}>
        ...
        <section className={styles.integrante}>
          ...
          <div className={styles.textos}>
            ...
            <p>
              Desde que tengo uso de razón, he buscado oportunidades para ampliar mi conocimiento en
              distintas áreas. He estudiado música, soy preceptora en nivel secundario y también me
              desempeño como peluquera canina. Actualmente, estoy cursando la carrera de Ingeniería
              Industrial.
            </p>

            <p>
              Motivada por mi interés en adquirir nuevos conocimientos y por el afán de seguir
              incursionando en nuevas disciplinas, me interesé por la programación. Creo que esta
              disciplina ofrece muchas posibilidades y puedo utilizarla como complemento para mi
        ...
        <section className={styles.integrante}>
          ...
          <div className={styles.textos}>
            ...
            <p>
              Aunque soy Preparador Físico de formación, siempre he tenido una pasión por la
              tecnología. Ahora quiero centrarme en mi pasión tecnológica y hacer del deporte un
              hobby. Durante mi formación como programador he aprendido a estar muy enfocado en los
              objetivos, lo cual me ha ayudado a estar preparado para cualquier desafío que se me
              presente en el futuro.
            </p>

            <p>
              Me emociona pensar dónde me llevará mi futuro como desarrollador y estoy ansioso por
              seguir aprendiendo y creciendo en mi carrera.
            </p>
          </div>
        </section>
        <section className={styles.integrante}>
          ...
          <div className={styles.textos}>
            ...
            <p>
              Soy Jeremías de Miguel, un apasionado desarrollador de software de 19 años. Completé
              un curso en Herny y actualmente estudio Desarrollo de Software en la Universidad
              Nacional de Cuyo. Con mi equipo, desarrollamos con éxito una página web eficiente y
              fácil de usar.
            </p>
            <p>
              Mi amor por la tecnología va más allá del desarrollo de software; disfruto explorando
              nuevos programas y herramientas. Entreno y me divierto con la cultura japonesa y los
              videojuegos. Aunque puedo ser impaciente, siempre manejo mis emociones para no afectar
              mi trabajo. La música es una de mis pasiones y siempre busco mejorar mis habilidades y
              aprender nuevas tecnologías. ¡Estoy emocionado de mostrar todo lo que he aprendido!
            </p>
